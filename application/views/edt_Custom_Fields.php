		  	...
		  	<div class="row">
		  		<form id="cffrm">
		  		   <div class="input-field col s6 m1">
			          <input placeholder="" id="first_name" name="name" value="<?php echo $u['name']; ?>"  type="text" class="validate">
			          <label for="first_name">Name / Label</label>
			        </div>
			          <div class="input-field col s12 m2">
					   <select id="type" name="type" class="">
						<option value="<?php echo $u['type']; ?>" selected><?php echo $u['type']; ?></option>
      				...
      				<input type="hidden" name="id" value="<?php echo $u['id']; ?>">
					   ...
					   <div class="col s12 m1"><a id="edtsavebtn" class="editlink" href="#null">Save</a></div>
					   </form>
		  	</div>
		  </div>
<?php 
