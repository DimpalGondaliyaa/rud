 <div class="main-box">
 	<div class="cmdtitle"><a href="<?php echo base_url(); ?>home">contact</a> > <a href="<?php echo base_url(); ?>Preview_Plans">student loan calculator</a></div>
 	   <div class="main-menu row">
 		  <nav class="contactnav">
		    <div class="nav-wrapper connavwapp">
		      <ul id="nav-mobile" class="hide-on-med-and-down">
		        <li><a class="uppdf"><img class="iconstyle" src="<?php echo base_url() ?>html/images/computer.png">FSA</a></li>
		        <li><a class="uppdf"><img class="iconstyle" src="<?php echo base_url() ?>html/images/film.png">youtube video</a></li>
		        <li><a class="uppdf"><img class="iconstyle" src="<?php echo base_url() ?>html/images/calculator.png">Federal Online Calc</a></li>
		      </ul>
		    </div>
		  </nav>

				  <div class="rebox">
				  	Important Information Regarding Student Loan Puller / Calculator. Click Here
				  </div>
<div class="col s12 m2">
		  <div class="row pdfrow">
		    <form class="col s12 m12" id="pdffrm">
		      <div class="row">
		       
		         <div class="input-field col s12 m12">
		          <input placeholder="" name="user" type="text" class="validate">
		          <label>FSA USER</label>
		        </div>

		        <div class="input-field col s12 m12">
		          <input placeholder="" name="user" type="text" class="validate">
		          <label>FSA PASS</label>
		        </div>

		        <div class="btbnbn"><a href="#" class="btn">get loan file</a></div>
              ...
              <h4>date of birth</h4>
		        ...
		        <div class="input-field col s12 m4">
		          <select id="qqslci[dob]" name="qqslci[dob]" class="">
...
<option value="31">31</option>
		        ...
		        <div class="input-field col s12 m4">
		         <select id="qqslci[yob]" name="qqslci[yob]" class="">
...
<option value="2018">2018</option>
		         ...
		         <div class="input-field col s12 m12">
		          <input placeholder="" name="user" type="text" class="validate">
		          <label>Annual Adjusted Gross Income</label>
		        </div>

		          <div class="input-field col s12 m12">
				   <select id="qqslci[marital_status]" name="qqslci[marital_status]" class="">
...
<option value="Head of Household">Head of Household</option>
				  ...
				  <div class="input-field col s12 m12">
		          <input placeholder="" name="user" type="text" class="validate">
		          <label>Annual Adjusted Gross Income (Spouse)</label>
		        </div>
		         ...
		         <div class="input-field col s12 m12">
		          <input placeholder="" name="user" type="text" class="validate">
		          <label>Spouse Indebtedness Amount</label>
		        </div>

				  <div class="input-field col s12 m12 ">
					<select id="qqslci[state_of_residence]" name="qqslci[state_of_residence]" class="">
<optgroup label="US"><option value="AL">Alabama</option><option value="AK">Alaska</option><option value="AS">American Samoa</option><option value="AZ">Arizona</option><option value="AR">Arkansas</option><option value="CA">California</option><option value="CO">Colorado</option><option value="CT">Connecticut</option><option value="DE">Delaware</option><option value="DC">District of Columbia</option><option value="FL">Florida</option><option value="GA">Georgia</option><option value="GU">Guam</option><option value="HI">Hawaii</option><option value="ID">Idaho</option><option value="IL">Illinois</option><option value="IN">Indiana</option><option value="IA">Iowa</option><option value="KS">Kansas</option><option value="KY">Kentucky</option><option value="LA">Louisiana</option><option value="ME">Maine</option><option value="MD">Maryland</option><option value="MA">Massachusetts</option><option value="MI">Michigan</option><option value="MN">Minnesota</option><option value="MS">Mississippi</option><option value="MO">Missouri</option><option value="MT">Montana</option><option value="NE">Nebraska</option><option value="NV">Nevada</option><option value="NH">New Hampshire</option><option value="NJ">New Jersey</option><option value="NM">New Mexico</option><option value="NY">New York</option><option value="NC">North Carolina</option><option value="ND">North Dakota</option><option value="OH">Ohio</option><option value="OK">Oklahoma</option><option value="OR">Oregon</option><option value="PA">Pennsylvania</option><option value="PR">Puerto Rico</option><option value="RI">Rhode Island</option><option value="SC">South Carolina</option><option value="SD">South Dakota</option><option value="TN">Tennessee</option><option value="TX">Texas</option><option value="VI">U.S. Virgin Islands</option><option value="UT">Utah</option><option value="VT">Vermont</option><option value="VA">Virginia</option><option value="WA">Washington</option><option value="WV">West Virginia</option><option value="WI">Wisconsin</option><option value="WY">Wyoming</option></optgroup><optgroup label="AF"><option value="AA">AA-Armed Forces Americas</option><option value="AE">AE-Armed Forces Other</option><option value="AP">AP-Armed Forces Pacific</option></optgroup><optgroup label="CA"><option value="AB">Canada-Alberta</option><option value="BC">Canada-British Columbia</option><option value="MB">Canada-Manitoba</option><option value="NB">Canada-New Brunswick</option><option value="NL">Canada-Newfoundland</option><option value="NT">Canada-Northwest Territories</option><option value="NS">Canada-Nova Scotia</option><option value="NU">Canada-Nunavet</option><option value="ON">Canada-Ontario</option><option value="PE">Canada-Prince Edward Island</option><option value="QC">Canada-Quebec</option><option value="SK">Canada-Saskatchewan</option><option value="YT">Canada-Yukon</option></optgroup><optgroup label="AU"><option value="NSW">AU-New South Wales</option><option value="ANT">AU-Northern Territory</option><option value="QLD">AU-Queensland</option><option value="SA">AU-South Australia</option><option value="TAS">AU-Tasmania</option><option value="VIC">AU-Victoria</option><option value="WAU">AU-Western Australia</option></optgroup>
		        ...
		        <div class="btbnbn">
		        	<a style="background-color: #92D2F7;" href="#" class="btn">save as new</a>
		        </div>
    ...
    <div class="col s12 m10">
		<div class="yellowbox">
			WARNING: ENROLLING AGENT CANNOT CREATE FSA ACCOUNT FOR THE CLIENT. ONLY THE CLIENT CAN CREATE THE FSA ACCOUNTS. TALKING A CLIENT THOUGH FSA SETUP AND CREATION VIA PHONE IS ACCEPTABLE.
		</div>
	</div>
</div>
