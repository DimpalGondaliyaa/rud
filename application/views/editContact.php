 				...
 				<div class="bottom-box">
 					<div>
 						<ul class="settlistthin">
 							<li id="tab_18866" class="noicon tb"><a href="#!">Contact Info</a></li>
 							<li data-id="tab_1" class="noicon  active"><a href="#!">Address Info</a></li>
 							<li data-id="tab_2" class="noicon tb"><a href="#!">Employer</a></li>
 							<li data-id="tab_3" class="noicon tb"><a href="#!">Additional Info</a></li>
 							<li data-id="tab_4" class="noicon tb"><a href="#!">Reference #1</a></li>
 							<li data-id="tab_5" class="noicon tb"><a href="#!">Reference #2</a></li>
 				...
 				<div class="row no-gutter">
                    <div id="contact-details">
                        <div class="col s12 m7 left ttl">
                            <p><span class="ttl-g" style=" font-size: 20px !important;letter-spacing: 0 !important;font-family: sans-serif;">Test User > </span><span class="infobox" id="infobox">Contact Info</span></p>
