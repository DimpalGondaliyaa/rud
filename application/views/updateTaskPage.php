<div class="row conrow">
 	<form  id="updateeTasks" name="updateeTasks" method="POST">
    <div class="row">
        ...
        <div class="col s12 m8">
          <select id="task" name="task" id="task" class="" style="max-width:250px;">
            ...
            <optgroup label="Everyone">
              <option value="Returned Payment" <?php if($task == 'Returned Payment'){ ?> selected <?php } ?>>Returned Payment</option>
              <option value="Submit to DOE" <?php if($task == 'Submit to DOE'){ ?> selected <?php } ?>>Submit to DOE</option>
            </optgroup>
          </select>
        </div>
      </div>
      ...
      <div class="col s12 m12 valign-wrapper">
        ...
        <div class="col s12 m8">
        <span class="dt"><i class="far fa-calendar-alt"></i></span><input type="text" class="datepicker" name="task_date" value="<?= $task_date;?>">
        </div>
      </div>
...
?>
      ...
      <div class="col s12 m12 valign-wrapper">
        ...
        <input type="hidden" name="contact" value="<?= $f_name.' '.$l_name;?>">
        <div class="col s12 m8"><label><?= $f_name.' '.$l_name;?></label></div>
      </div>

      <div class="col s12 m12 valign-wrapper">
        <div class="col s12 m4"><label>Notes</label></div>
        <div class="col s12 m8"><textarea name="note"><?= $note;?></textarea></div>
      </div>
